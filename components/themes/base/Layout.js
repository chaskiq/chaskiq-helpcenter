...
export default function Layout({ children, className, site }) {
  ...
  return (
    <div className="flex flex-col antialiased sm:subpixel-antialiased md:antialiased">
						...
						<div>
							<div className={'flex items-center space-between'}>
								<a
									...
									className={'mr-2 inline-flex justify-center w-full px-4 py-2 text-sm font-medium text-white bg-black rounded-md bg-opacity-20 hover:bg-opacity-30 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75'}
									color={'primary'}
      ...
      <div className={ className || `flex flex-row items-center justify-center bg-gray-100`}>
				{/*JSON.stringify(site)*/}
        {children}
      </div>
